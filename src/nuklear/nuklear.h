...
NK_API nk_flags					nk_edit_buffer(struct nk_context *ctx, nk_flags flags, struct nk_text_edit *edit, nk_plugin_filter filter);
...
NK_API void nk_draw_list_add_colored_text(struct nk_draw_list*, const struct nk_user_font*, struct nk_rect, const char *text, int textLen, const char* color, int colorLen, const nk_color* colorTable, float font_height);
#ifdef NK_INCLUDE_COMMAND_USERDATA
...
nk_widget_colored_text(struct nk_command_buffer *o, struct nk_rect b,
	const char *string, int stringLen, const char* colors, int colorsLen, const nk_color* colorTable,
